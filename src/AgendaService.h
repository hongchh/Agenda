...
class AgendaService {
 public:
  ...
  bool updateUserPassword(std::string userName, std::string password,
                          std::string newPassword);
  bool updateUserEmail(std::string userName, std::string password,
                       std::string email);
  bool updateUserPhone(std::string userName, std::string password,
                       std::string phone);
